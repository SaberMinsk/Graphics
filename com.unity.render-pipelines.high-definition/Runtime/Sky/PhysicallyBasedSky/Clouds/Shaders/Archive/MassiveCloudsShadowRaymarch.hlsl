...
#include "../Includes/CloudsSampler.hlsl"
#include "../Includes/CloudsShape.hlsl"
...
float SampleShadowDensity(float3 pos)
{
    ...
    float  sculpture    = _Sculptures.x * (1 + 2 * exp(-dist * 0.001));
    ...
    int    iteration)
{
    ...
    for (int i = 0; i < iteration; ++i)
    {
        ...
        float isClip = step(_HorizontalRegion.height - 0.001, ray.y);
